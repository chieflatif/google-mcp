...
async function obtainNewTokens(oauth2Client: OAuth2Client, scopes: string[]): Promise<any> {
...
let _calendarClient: OAuth2Client | null = null;
let _sheetsClient: OAuth2Client | null = null;
let _docsClient: OAuth2Client | null = null;
let _driveClient: OAuth2Client | null = null;

export async function getGmailOAuthClient(scopes: string[]): Promise<OAuth2Client> {
...
export async function getCalendarOAuthClient(scopes: string[]): Promise<OAuth2Client> {
...
export async function getSheetsOAuthClient(scopes: string[]): Promise<OAuth2Client> {
...
export async function getDocsOAuthClient(scopes: string[]): Promise<OAuth2Client> {
  if (_docsClient) return _docsClient;
...
export async function getDriveOAuthClient(scopes: string[]): Promise<OAuth2Client> {
